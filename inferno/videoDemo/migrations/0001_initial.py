# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-07-03 12:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendee', models.ManyToManyField(related_name='sdfsdaf', to='infernoWeb.User')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='videoDemo.Category')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='videoDemo.Company')),
            ],
        ),
        migrations.CreateModel(
            name='JobTag',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=15)),
                ('Job', models.ManyToManyField(to='videoDemo.Job')),
            ],
        ),
        migrations.CreateModel(
            name='LikesFromUser',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('author', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='lfuauth', to='infernoWeb.User')),
                ('comment', models.ManyToManyField(to='videoDemo.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='PageLog',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('create', models.DateTimeField(default=django.utils.timezone.now)),
                ('Job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='videoDemo.Job')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plogus', to='infernoWeb.User')),
            ],
        ),
        migrations.CreateModel(
            name='SkillTag',
        ...
        migrations.AddField(
            model_name='comment',
            name='Job',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='videoDemo.Job'),
        ),
        migrations.AddField(
            model_name='comment',
            name='author',
            field=models.ForeignKey(default=10, on_delete=django.db.models.deletion.CASCADE, related_name='cmtauth', to='infernoWeb.User'),
        ),
    ]
