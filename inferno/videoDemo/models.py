...
class Job(models.Model):
    ...
    attendee = models.ManyToManyField(User, related_name='sdfsdaf')
...
class Comment(models.Model):
    ...
    author = models.ForeignKey(User, related_name='cmtauth', default=10)
...
class LikesFromUser(models.Model):
    author = models.OneToOneField(User, related_name='lfuauth')
    comment = models.ManyToManyField(Comment)   
    def __str__(self):
        return self.author.name

class PageLog(models.Model):
    user = models.ForeignKey(User, related_name='plogus')
    Job = models.ForeignKey(Job)
    create = models.DateTimeField(default=timezone.now)
    def __str__(self):
